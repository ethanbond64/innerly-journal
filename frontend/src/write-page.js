...
export const WritePage = () => {
    return (
        <>
            <main style={{ height: `90vh`, padding: '0', margin: '0' }} className="container" >
                    <div className="row text-center" style={{ height: '90%' }}>
                        ...
                        <div className="col-lg-8 col-md-10" style={{ height: '97%' }}>
                            <div id="session-details" className="writeto-display" style={{ textAlign: 'left', border: 'none', overflow: 'visible' }}>
                                <div>
